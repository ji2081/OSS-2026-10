import { DISTRICTS, EDUCATION_OPTIONS, HOUSING_OPTIONS } from '../data/subsidies'
import './Sidebar.css'
    ...
    <aside className="sidebar">
      ...
      <div className="condition-tabs">
        {conditionSets.map(set => (
          <button
            key={set.id}
            className={`condition-tab ${set.id === activeSetId ? 'active' : ''}`}
      ...
      <div className="sidebar-fields">
        ...
        <div className="field-group">
          <div className="field-label-row">
            ...
            <span className="field-value">
              {condition.annualIncome === 0 ? '소득 없음' : `${condition.annualIncome.toLocaleString()}만원`}
            </span>
          </div>
          <div className="income-input-wrap">
            <input
              ...
              onChange={(e) => onUpdateCondition('annualIncome', Number(e.target.value))}
        ...
        <div className="field-group">
          <div className="field-label-row">
            <label>부모소득</label>
            <span className="field-value">
              {condition.parentIncome === 0 ? '없음' : `${condition.parentIncome.toLocaleString()}만원`}
            </span>
          </div>
          <div className="income-input-wrap">
            <input
              ...
              onChange={(e) => onUpdateCondition('parentIncome', Number(e.target.value))}
              className="number-input"
              placeholder="0"
            />
            <span className="input-unit">만원</span>
        ...
        <div className="field-group">
          ...
          <select
            ...
            onChange={(e) => onUpdateCondition('educationStatus', e.target.value)}
