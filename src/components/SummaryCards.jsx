...
function SummaryCards({ totalAmount, selectedCount, totalCount, hasOptimized }) {
  return (
    <div className="summary-cards">
      ...
      <div className="summary-card">
        <div className="card-header">
          ...
          <span className="card-icon" style={{ background: '#E8F9EE', color: '#34C759' }}>₩</span>
        </div>
        <div className="card-value">
          {hasOptimized ? (
            <>
              <span className="value-number">{totalAmount.toLocaleString()}</span>
      ...
      <div className="summary-card">
        <div className="card-header">
          ...
          <span className="card-icon" style={{ background: '#E8F6FE', color: '#5AC8FA' }}>📋</span>
        </div>
        <div className="card-value">
          {hasOptimized ? (
            <>
